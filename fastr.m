...
function EEG=fastr(EEG,lpf,L,Window,Trigs,strig,anc_chk,tc_chk,Volumes,Slices,varargin)
...
nSteps = m;
step = 0;
fprintf(1, 'Artifact Subtraction: |');
...
%             PCS(c)=pcs;
    ...
    %Update progress bar
    [step, strLength] = mywaitbar(c, m, step, nSteps, strLength);     
end
