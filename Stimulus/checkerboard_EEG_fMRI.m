function checkerboard_EEG_fMRI( shape,trialTime,trialNum,blockNum,cbSize )
% checkerboard stimulus for EEG-fMRI
% checkerboard_EEG_fMRI( sidelength,trialTime,trialNum,blockNum,cbSize )
% Input Params
% sidelength: single box size
% trialTime
% trialNumber
% blockNum
% cbSize: ratio of checkerboard vs screen size, 1 full screen
%
% Huang Xiaoshan, xiaoshanhuang@gmail.com, 2012-3-4
% Trigger Configer, Huang Xiaoshan, 20120331
% Edited for BCG Artifact only, Huang Xiaoshan, 20120417
