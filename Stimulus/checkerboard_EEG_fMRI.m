...
% Usage:
%	  checkerboard_EEG_fMRI( shape,trialTime,trialNum,blockNum,cbSize );
%
% Inputs:
%     shape     : 'circ' or 'rect'
...
%
% Versions:
%	v0.1:   2012-3-4, orignal
%   v0.2:   2012-3-31, Trigger Configer
%   v0.3:   2012-4-17, Edited for BCG Artifact only
%   v0.4:   2013-09-03 18:38, for BCG layer VEP
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
