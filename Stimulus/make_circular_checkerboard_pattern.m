function [f f_inv]=make_circular_checkerboard_pattern(sigma,spokes,SUP)
% usage 
% [f f_inv]=make_circular_checkerboard_pattern(2,4,500);
% $author Shripad Kondra, NBRC, India (28-09-2010)
% edited by Xiaoshan Huang, xiaoshanhuang@gmail.com
if (nargin==0)
sigma=4;
spokes=6;
